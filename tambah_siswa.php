...
<div class="container">
	...
	<button type = "logout" class="btn btn-danger"><a style = "text-decoration:none; color:white;" href="./grade/grade5.php"</a>Grade 5</button>
	<button type = "logout" class="btn btn-danger"><a style = "text-decoration:none; color:white;" href="./grade/grade6.php"</a>Grade 6</button>
