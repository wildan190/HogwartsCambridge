...
<head>
  ...
  <title>Pricing - Hogwarts Bootstrap Template</title>
...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Pricing</h2>
        <p>Hogwarts memiliki berbagai varian biaya pendidikan dan Beasiswa.</p>
      </div>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="box">
              ...
              <ul>
                <li>Fasilitas Laboratorium</li>
                <li>Free Laptop</li>
                <li class="na">School Cab Service</li>
                <li class="na">Tour</li>
                <li>Konselling Teacher</li>
              </ul>
              <div class="btn-wrap">
                <a href="regist.php" class="btn-buy">Daftar Sekarang</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
            <div class="box featured">
              ...
              <ul>
                <li>Fasilitas Laboratorium</li>
                <li class="na">Free Laptop</li>
                <li class="na">School Cab Service</li>
                <li>Tour</li>
                <li>Conselling Teacher</li>
              </ul>
              <div class="btn-wrap">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <div class="box">
              ...
              <ul>
                ...
                <li class="na">School Cab Service</li>
                <li class="na">Tour</li>
                <li class="na">Conselling Teacher</li>
              </ul>
              <div class="btn-wrap">
                <a href="regist.php" class="btn-buy">Daftar Sekarang</a>
              </div>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <div class="box">
              ...
              <h3>Khusus Anak Mentri</h3>
              <h4><sup>$</sup>49<span> / month</span></h4>
              <ul>
                <li>Fasilitas Laboratorium</li>
                <li>School Cab Service</li>
                <li>Special Classroom</li>
                <li>Tour</li>
                <li>Konselling Teacher</li>
              </ul>
              <div class="btn-wrap">
