...
<head>
  ...
  <title>Alumni - Hogwarts Bootstrap Template</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/alumni/potter.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Harry Potter</h4>
                <span>Prime Minister of Wizard</span>
                <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/alumni/hermione.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Hermione Granger</h4>
                <span>Spell Magic Teacher</span>
                <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/alumni/luna.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Luna Lovegood</h4>
                <span>Wands Entrepreneur</span>
                <p>
                Everyone is thinking of changing the world, but no one is thinking of changing itself.
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
