        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Email:</strong> hogwardsacademy<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="pricing.php">Services</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="about.php">Terms of service</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="vnm.php">Privacy policy</a></li>
            </ul>
          </div>
